...
import kr.co.chazm.member.service.MailService;
...
public class MailServiceImpl implements MailService{
	  ...
	  @Autowired
	    ...
	    public MimeMessage creatMessage(String to) throws MessagingException, UnsupportedEncodingException {
	        ...
	        message.setSubject("[찾음] 이메일 인증코드 입니다"); // 이메일 제목

	        String msgg = "";
	        // msgg += "<img src=../resources/static/image/emailheader.jpg />"; // header image
	        msgg += "<h1>안녕하세요</h1>";
	        msgg += "<h1>분실물 통합 관리 포털 찾음입니다</h1>";
	        msgg += "<br>";
	        ...
	        message.setFrom(new InternetAddress("ktweb5951@naver.com", "찾음"));
