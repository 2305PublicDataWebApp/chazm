                    ...
                    <div class="row gy-4 align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="stats-item d-flex align-items-center">
                                <span data-purecounter-start="0" data-purecounter-end="${totalMember }" data-purecounter-duration="1"
                                    class="purecounter"></span>
                                <p><strong>가입자</strong>가 찾음과 함께해요.</p>
                            </div><!-- End Stats Item -->

                            <div class="stats-item d-flex align-items-center">
                                <span data-purecounter-start="0" data-purecounter-end="${totalBoard }" data-purecounter-duration="1"
                                    class="purecounter"></span>
                                <p><strong>건</strong>의 글이 등록됐어요.</p>
                            </div><!-- End Stats Item -->

                            <div class="stats-item d-flex align-items-center">
                                <span data-purecounter-start="0" data-purecounter-end="${totalGetY }" data-purecounter-duration="1"
                                    class="purecounter"></span>
