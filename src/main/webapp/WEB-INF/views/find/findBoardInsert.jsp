...
<html lang="ko">
	...
	<body>
					...
					<div class="row g-5">
						<div class="col-lg-12">
							<form action="/findBoard/insert.do" method="post"
								enctype="multipart/form-data" onsubmit="insert();">
												...
												<div id="find_category" class="">
													<div class="btn-group w-100 m-2">
														...
														<ul class="dropdown-menu">
															<li><a class="dropdown-item dd-category"
																data-value="지갑">지갑</a></li>
															<li><a class="dropdown-item dd-category"
																data-value="가방">가방</a></li>
															<li><a class="dropdown-item dd-category"
																data-value="핸드폰">핸드폰</a></li>
															<li><a class="dropdown-item dd-category"
																data-value="의류">의류</a></li>
															<li><a class="dropdown-item dd-category"
									...
									<div id="buttons" class="d-flex justify-content-end">
										<div>
											<button type="submit" class="btn"
												style="background-color: #4365BC; color: #fff">등록하기</button>
										</div>
									</div>
								</article>
								<!-- End blog post -->
		...
		<script>
        	<!-- 글 등록 유효성 체크 -->
        	function insert() {
        		const findTitle = document.querySelector("#findTitle").value;
        		const findContent = document.querySelector("#summernote").value;
        		const findCategory = document.querySelector("#selectedCategoryInput").value;
        		const findPlace = document.querySelector("#selectedPlaceInput").value;
        		const findLocation = document.querySelector("#selectedLocationInput").value;
        		const findDate = document.querySelector("#findDate").value;
        		const findColor = document.querySelector("#selectedColorInput").value;
        		const file = document.querySelector("#imageUpload").value;
        		
        		if (findTitle.trim() == '') {
        			alert('제목(습득물명)을 입력하세요');
        	        return false;
       	        } else if (findContent.trim() == '') {
        			alert('내용을 입력하세요');
        	        return false;
       	        } else if (findCategory.trim() == '') {
        			alert('습득물 종류를 선택하세요');
        	        return false;
       	        } else if (findPlace.trim() == '') {
        			alert('습득 장소를 선택하세요');
        	        return false;
       	        } else if (findLocation.trim() == '') {
        			alert('습득 지역을 선택하세요');
        	        return false;
       	        } else if (findDate.trim() == '') {
        			alert('습득일자를 선택하세요');
        	        return false;
       	        } else if (findColor.trim() == '') {
        			alert('습득물 색상을 선택하세요');
        	        return false;
       	        } else if (file.trim() == '') {
        			alert('이미지파일을 첨부하세요');
