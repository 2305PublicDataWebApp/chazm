...
<!-- CSS -->
<link rel="stylesheet"
	href="../resources/assets/css/find/findUpdate.css">
	...
	<main id="main">
		...
		<section id="blog" class="blog">
			<div class="container" data-aos="fade-up">
				<div class="row g-5">
					<div class="col-lg-12">
						<form action="/findBoard/update.do" method="post"
							...
							<article class="blog-details">
										...
										<div id="find_info_wrap">
											...
											<div id="find_category" class="">
												<div class="btn-group w-100 m-2">
													<button type="button" id="findCategory"
														...
														<h5 style="display: inline;" id="selectedCategory">${findBoard.findCategory }</h5>
													</button>
													<ul class="dropdown-menu">
														<div class="d-flex">
															<li><div data-value="지갑"
																	class="dropdown-item category-icon dd-category">
																	<div class="icon">
											...
											<div id="find_place">
												<div class="btn-group w-100 m-2">
													<button type="button"
														...
														style="border: none; color: #fff;"
														data-bs-toggle="dropdown" aria-expanded="false">
														<h5 style="display: inline;" id="selectedPlace">${findBoard.findPlace }</h5>
													</button>
													<ul class="dropdown-menu">
														<div class="d-flex">
															<li><div data-value="버스"
																	class="dropdown-item category-icon dd-place">
																	<div class="icon">
												...
												<input type="hidden" name="findPlace"
													id="selectedPlaceInput" value="${findBoard.findPlace }">
											</div>
											...
											<div id="find_location" class="">
												...
												<input type="hidden" name="findLocation"
													id="selectedLocationInput"
													value="${findBoard.findLocation }">
											</div>
											...
											<div class="input-group m-2 w-100">
												<p>
													등록된 이미지 : <a
														href="../resources/fuploadFiles/${findBoard.findFilerename }"
														download>${findBoard.findFilename }</a>
												</p>
											</div>
											<div class="input-group m-2 w-100">
												<input type="file"
													...
													id="imageUpload"
													value="../resources/fuploadFiles/${findBoard.findFilerename }"
													name="uploadFile" accept="image/*"
													onchange="setThumbnail(event);"> <input
													type="hidden" name="findFilename"
													value="${findBoard.findFilename }"> <input
													type="hidden" name="findFilerename"
													value="${findBoard.findFilerename }"> <input
													type="hidden" name="findFilepath"
													value="${findBoard.findFilepath }">
											</div>
										</div>
									</div>
								</div>
								...
								<div id="container"
									...
									<textarea id="summernote" name="findContent" spellcheck="false" required>${findBoard.findContent }</textarea>
								...
								<div id="buttons" class="d-flex justify-content-end">
									<div>
										<button type="submit" class="btn"
											...
											onClick="return updateCheck()">수정하기</button>
									</div>
								</div>
