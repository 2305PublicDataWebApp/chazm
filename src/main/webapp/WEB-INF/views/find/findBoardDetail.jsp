...
<html lang="ko">
	...
	<body>
							...
							<article class="blog-details">
								...
								<div class="meta-top">
									<ul>
										...
										<li class="d-flex align-items-center"><i
											class="bi bi-clock"></i> <time datetime="2020-01-01">${findBoard.fCreateDate }</time></li>
										<li class="d-flex align-items-center"><i
											class="bi bi-chat-dots"></i>${totalCount } Comments</li>
									</ul>
								</div>
								<!-- End meta top -->
		...
		<script>
			...
			// 대댓글 수정폼 
			function showAddModifyForm(findRNo) {
				const AddModifyForm = document.querySelector("#AddModifyForm-" + findRNo);
