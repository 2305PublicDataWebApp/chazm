							...
							<div class="content">
								...
								<div class="donation-btn">
									<button type="button" class="btn btn-primary"
										style="width: 100px; height: 30px; font-size: 6px; float: right;" onclick="checkDelete();">회원
										탈퇴</button>
								</div>
								<br>
							</div>
...
<div>
						...
						<div class="mb-3 custom-input">
							...
							<div class="input-group">
								<input type="text" class="form-control" id="memberPhone"
									name="memberPhone" required placeholder="핸드폰 번호를 입력해 주세요" value="${member.memberPhone }">
						...
						<div class="mb-3 custom-input">
							...
							<div class="input-group">
								<input type="email" class="form-control" id="memberEmail"
									name="memberEmail" required placeholder="이메일을 입력해 주세요" value="${member.memberEmail }">
								<button class="btn btn-outline-secondary" type="button"
						...
						<div class="mb-3">
							...
							<div class="input-group">
								<input type="text" class="form-control" id="memberPostCode"
									name="memberPostCode" required placeholder="우편 번호" value="${member.memberPostCode }">
								<button class="btn btn-outline-secondary" type="button"
									id="searchPostalCode" onclick="sample6_execDaumPostcode();">우편번호 검색</button>
							</div>
							<input type="text" class="form-control" id="memberAddress"
								name="memberAddress" required
								placeholder="주소(우편 번호 검색 시 자동 입력됩니다.)" value="${member.memberAddress }"> <input
								type="text" class="form-control" id="memberDetailAddress"
								name="memberDetailAddress" placeholder="상세주소를 입력해 주세요" value="${member.memberDetailAddress }"> 
						</div>
	...
	<script>
		...
		function openModal() {
		    ...
		    document.getElementById("searchPostalCode").addEventListener("click", sample6_execDaumPostcode);
		}
		...
		function closeModal() {
		    ...
		    document.getElementById("searchPostalCode").removeEventListener("click", sample6_execDaumPostcode);
		}
