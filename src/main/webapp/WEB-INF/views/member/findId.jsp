				...
				<div class="container mt-5">
					<div class="row">
						<div class="col-md-12">
							...
							<hr>
							<!-- 이메일 인증 폼 -->
							<div id="emailAuthenticationForm" style="display: block;" class="mt-3">
							    <h1>이메일 인증</h1>
							    <form action="/member/findIdByEmail.do" method="post">
							        <div class="input-group">
							            <input type="email" class="form-control" id="memberEmail" name="memberEmail" required placeholder="이메일을 입력해 주세요">
							            <button class="btn btn-outline-secondary" type="button" id="verifyEmail">인증</button>
							        </div>
							        <div class="input-group">
							            <input type="text" class="form-control" id="enterAuthenticationEmailNo" name="enterAuthenticationEmailNo" required placeholder="인증번호 입력">
							            <button class="btn btn-outline-secondary" type="button" id="findIdByEmail">인증확인</button>
							        </div>	
							        <button class="btn btn-lg login-button" type="submit" id="findIdEmail" >아이디 찾기</button>							        					        
							        <div id="emailError" class="validation"></div>
							    </form>
							</div>
							
							<!-- 핸드폰 인증 폼 -->
							<div id="phoneAuthenticationForm" style="display: none;" class="mt-3">
							    <h1>핸드폰 인증</h1>
							    <form action="/member/findIdByPhone.do" method="post">
							        <div class="input-group">
							            <input type="text" class="form-control" id="memberPhone" name="memberPhone" required placeholder="핸드폰번호를 입력해 주세요">
							            <button class="btn btn-outline-secondary" type="button" id="verifyPhone">인증</button>
							        </div>
							        <div class="input-group">
							            <input type="text" class="form-control" id="enterAuthenticationPhoneNo" name="enterAuthenticationPhoneNo" required placeholder="인증번호 입력">
							            <button class="btn btn-outline-secondary" type="button" id="findIdByPhone">인증확인</button>
							        </div>								        
							        <button class="btn btn-lg login-button" type="submit" id="findIdPhone">아이디 찾기</button>
